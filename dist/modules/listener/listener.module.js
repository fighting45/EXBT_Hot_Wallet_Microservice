...
exports.ListenerModule = ListenerModule = __decorate([
    (0, common_1.Module)({
        imports: [typeorm_1.TypeOrmModule.forFeature([entities_1.ProcessedDeposit, entities_1.NetworkSyncState, entities_1.WalletAddress])],
        providers: [listener_service_1.ListenerService, bootstrap_service_1.BootstrapService],
